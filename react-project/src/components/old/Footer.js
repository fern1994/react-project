...
const Footer = () => {
  return(
    <div className="w-100 bt b--light-gray bg-dark-gray">
    <footer className="pv2 ph3 ph5-ns tc">
      <p className="white">footer.</p>
      {/* <a className="link dim black dib h2 w2 br-100 mr3 pa2 bg-near-white ba b--black-10" href="/" title="">
      ...
      <a className="link dim black dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" href="/" title="">
